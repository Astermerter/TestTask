...
Так же общие шаблоны для создания main.v и test.v (файла логики и файла тестирования) есть в директории проекта (при создании файлов они будут не похожи на шаблоны, шаблоны лишь отражают общее решение)